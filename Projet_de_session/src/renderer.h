group_Pvector.setup("Type de forme");// IFT3100H19_Triptyque/renderer.h
...
public:
  ...
  //version of du shader de g�om�trie. Inutilisable parce qu'il enl�ve ceux par d�faut qui sont n�c�ssaires pour voir les surfaces. Mais on voit bien l'ombre.
  ofShader s;
